  ...
  return (
    <div className="h-full flex flex-col max-w-4xl mx-auto px-2 sm:px-4 lg:px-8">
      ...
      <div className="flex-shrink-0 pb-2 sm:pb-4">
        <h1 className="text-lg sm:text-2xl lg:text-3xl font-bold mb-2 sm:mb-3">{t('vocabulary.vietnamese.title')}</h1>
        
        <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-2 sm:p-3 lg:p-4 mb-2 sm:mb-3">
          <h2 className="text-sm sm:text-base lg:text-lg font-semibold mb-1 sm:mb-2">{t('vocabulary.vietnamese.about.title')}</h2>
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-2 sm:space-y-0">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-2 order-1 sm:order-2">
            <Link
              ...
              className="px-2 sm:px-3 lg:px-4 py-1.5 sm:py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors text-center text-xs sm:text-sm lg:text-base"
            >

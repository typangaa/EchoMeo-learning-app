...
import OldFlashcardPractice from '../components/vocabulary/flashcard/OldFlashcardPractice';
...
const FlashcardPage = () => {
  ...
  if (!selectingOptions) {
    return <OldFlashcardPractice vocabularyItems={getItemsForPractice()} onComplete={handleComplete} />;
  }

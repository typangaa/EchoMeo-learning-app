...
import VietnameseLevelSidebar from '../components/vocabulary/vietnamese/VietnameseLevelSidebar';
...
const VietnameseVocabularyViewPage: React.FC = () => {
  ...
  const currentVocabulary = vietnameseVocabulary.get(selectedLevel.toString()) || [];
  const filteredVocabulary = currentVocabulary.filter(item => {
    ...
    const matchesFavorites = !showFavorites || favorites.vietnamese.has(item.id);
  ...
  useEffect(() => {
    loadVocabulary('vietnamese', selectedLevel);
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="flex h-screen">
        ...
        <div className="hidden lg:block">
          <VietnameseLevelSidebar
            selectedLevel={selectedLevel}
            onLevelChange={handleLevelChange}
            vocabularyCount={currentVocabulary.length}
            favoriteCount={favorites.vietnamese.size}
            isLoading={loading.vietnamese}
          />
        </div>
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 flex overflow-hidden">
            ...
            <div 
              className="flex-1 flex flex-col items-center justify-start p-0 sm:p-4 lg:p-8 overflow-hidden sm:overflow-y-auto max-h-full"
            ...
            >
              {loading.vietnamese ? (
                ...
                <VietnameseSingleVocabularyCard
                  item={currentItem}
                  onToggleFavorite={handleToggleFavorite}
                  isFavorite={favorites.vietnamese.has(currentItem.id)}
                />
              ) : (
...
export default VietnameseVocabularyViewPage;
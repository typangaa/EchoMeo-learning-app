...
const HSKSingleVocabularyCard: React.FC<HSKSingleVocabularyCardProps> = ({
  ...
  return (
    <div className="max-w-xl sm:max-w-2xl w-full bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
      ...
      <div className="text-center mb-6">
        <div className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-3">
          ...
          {item.traditional && item.traditional !== (item.simplified || item.chinese) && (
            <span className="text-2xl sm:text-3xl text-gray-500 dark:text-gray-400 ml-2">
              ({item.traditional})
            </span>
          )}
        </div>
        ...
        <div className="bg-red-50 dark:bg-red-900/20 rounded-lg p-4">
          <div className="flex justify-between items-center">
            <div className="flex-1">
              ...
              <div className="text-base text-red-800 dark:text-red-300">
                {item.vietnamese}
              </div>
            </div>
            <AudioButton
              ...
              language="vietnamese"
              className="text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 ml-3"
            />
          </div>
        </div>

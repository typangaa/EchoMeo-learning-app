...
:: Vietnamese Vocabulary Generator Runner
:: This batch file helps run the Vietnamese vocabulary generator with various options

echo.
echo ================================================================
echo Vietnamese Vocabulary Generator Runner
echo ================================================================
echo.
...
:all_levels
echo.
echo Running Vietnamese vocabulary generator for ALL HSK levels (1-7)
...
echo.
echo Running Vietnamese vocabulary generator for HSK level %level%
echo This may take 1-3 hours depending on the level size...
echo.
python vietnamese_vocabulary_generator.py --level %level%
goto :end
...
if "%level%"=="" (
    ...
    python vietnamese_vocabulary_generator.py --model %model%
) else (
    ...
    python vietnamese_vocabulary_generator.py --level %level% --model %model%
)
goto :end
...
if "%level%"=="" (
    ...
    python vietnamese_vocabulary_generator.py --debug
) else (
    ...
    python vietnamese_vocabulary_generator.py --level %level% --debug
)
goto :end
...
:show_help
echo.
echo Vietnamese Vocabulary Generator Help
echo ===================================
echo.
echo This script generates Vietnamese vocabulary entries from HSK Chinese data.
echo.
echo Prerequisites:
...
echo.
echo Input files should be in: data/raw/
echo Output files will be saved to: data/vietnamese_generated/
echo.
echo Command line usage:
echo   python vietnamese_vocabulary_generator.py [options]
echo.
echo Options:
...
echo.
echo Examples:
echo   python vietnamese_vocabulary_generator.py --level 1
echo   python vietnamese_vocabulary_generator.py --model llama3.1:latest
echo   python vietnamese_vocabulary_generator.py --level 2 --debug
echo.
goto :end
...
echo Output files are saved in: data/vietnamese_generated/
echo ================================================================
echo.
pause
...
interface HSKVocabularyListPanelProps {
...
const HSKVocabularyListPanel: React.FC<HSKVocabularyListPanelProps> = ({
  vocabulary,
  currentIndex,
  onJumpToItem,
  onClose,
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    {item.traditional && item.traditional !== (item.simplified || item.chinese) && (
                      <>
                        ...
                        <span className="text-sm sm:text-base md:text-lg text-gray-700 dark:text-gray-300 truncate">
                          {item.traditional}
                        </span>
                      </>
                    )}
                  ...
                  {/* Pinyin */}
                  <div className="text-xs sm:text-sm text-blue-600 dark:text-blue-400 mb-1 truncate">
                    {item.pinyin}
                  </div>
...
export default HSKVocabularyListPanel;
...
interface HSKNavigationControlsProps {
  currentIndex: number;
  totalItems: number;
  onPrevious: () => void;
  onNext: () => void;
...
const HSKNavigationControls: React.FC<HSKNavigationControlsProps> = ({
  currentIndex,
  totalItems,
  onPrevious,
  onNext,
  ...
  return (
    <div className="hidden md:block bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-4">
...
export default HSKNavigationControls;
...
def main():
    # Define paths - Updated for analysis/ subfolder
    script_dir = os.path.dirname(os.path.abspath(__file__))
    scripts_root = os.path.dirname(script_dir)  # Go up one level to scripts root
    raw_data_dir = os.path.join(scripts_root, 'data', 'raw')
    enriched_data_dir = os.path.join(scripts_root, 'data', 'enriched', 'vocabulary')
    output_dir = os.path.join(scripts_root, 'analysis_output')
